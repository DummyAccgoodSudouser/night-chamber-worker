...
export default {
  async fetch(req:Request,env:Env){
    ...
    if(u.pathname==="/api/health"){
      return json({ok:true,version:"0.8.1",service:"night-chamber-worker",firebaseProject:env.FIREBASE_PROJECT_ID,durableObjects:true,time:new Date().toISOString()},200,req,env);
    }
